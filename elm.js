...
var _user$project$Main$sortOpportunitiesByDay = function (opportunities) {
	...
	var forDate = function (date) {
		return A2(
			...
			function (o) {
				return _elm_lang$core$Native_Utils.eq(o.date, date);
			},
			opportunities);
	};
	return A2(
...
var _user$project$Main$opportunityDecoder = A9(
	_elm_lang$core$Json_Decode$map8,
	_user$project$Main$SightingOpportunity,
	...
	A2(_elm_lang$core$Json_Decode$field, 'maximum_elevation', _elm_lang$core$Json_Decode$string),
...
var _user$project$Main$SatelliteInfo = F4(
	function (a, b, c, d) {
		return {url: a, description: b, items: c, expiresAt: d};
	});
var _user$project$Main$satelliteInfoDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Main$SatelliteInfo,
	A2(_elm_lang$core$Json_Decode$field, 'url', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode$field,
		'items',
		_elm_lang$core$Json_Decode$list(_user$project$Main$opportunityDecoder)),
	A2(_elm_lang$core$Json_Decode$field, 'expiresAt', _elm_lang$core$Json_Decode$int));
var _user$project$Main$Model = F2(
	function (a, b) {
		return {state: a, satelliteInfo: b};
	});
var _user$project$Main$LoadInfo = function (a) {
...
var _user$project$Main$getSatelliteInfo = function (url) {
	return A2(
		...
		A2(_elm_lang$http$Http$get, url, _user$project$Main$satelliteInfoDecoder));
};
	...
	function (msg, model) {
		...
		switch (_p3.ctor) {
			...
			default:
				if (_p3._0.ctor === 'Ok') {
					var _p4 = _p3._0._0;
					var $var = _elm_lang$core$Debug$log(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'foo ',
